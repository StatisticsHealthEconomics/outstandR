...
(or marginal) relative treatment effects. This is always as a difference so, for example,
...
Use the `gen_data()` function available with the [simcovariates](https://github.com/n8thangreen/simcovariates) package.
...
```{r outstandR_gcomp_stan, message=FALSE}
...
```{r forest-lor, fig.width=8, fig.height=6, warning=FALSE, message=FALSE}
library(ggplot2)
...
```{r forest-rr, fig.width=8, fig.height=6, warning=FALSE, message=FALSE}
library(ggplot2)
