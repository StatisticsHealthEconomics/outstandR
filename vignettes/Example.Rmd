...
```{r}
hat_Delta_stats_maic <- IPD_stats(AC.IPD, BC.ALD, strategy = "maic")
```
...
```{r}
hat_Delta_stats_stc <- IPD_stats(AC.IPD, BC.ALD, strategy = "stc")
...
```{r}
hat_Delta_stats_gcomp_ml <- IPD_stats(AC.IPD, BC.ALD, strategy = "gcomp_ml")
...
```{r}
hat_Delta_stats_gcomp_stan <- IPD_stats(AC.IPD, BC.ALD, strategy = "gcomp_stan")
