...
ggplot(all_results_final, aes(x = Estimate, y = Method, color = Method)) +
  ...
  # Highlight the True Effect (0.0) with a distinct line
  ...
  theme(
    legend.position = "bottom", # Show the legend so they see the "True Effect" label
    axis.text.y = element_text(size = 11, face = "bold"),
    plot.title = element_text(face = "bold", size = 14)
  ) +
  guides(color = "none") # Hide the redundant color legend for the methods
```
