...
If we interrogate the output we see the same list format. Differences to the first example are the model and scale attributes correspond to the input data used.
