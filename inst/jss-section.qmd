...
```{r}
outstandR_maic <- outstandR(
  ipd_trial = AC_IPD_countY_mixedX,
...
print(paste("Naive SE:", round(sqrt(stc_naive$contrasts$var), 4)))
print(paste("Robust SE:", round(sqrt(stc_robust$contrasts$var), 4)))
```
...
# outstandR_gcomp_custom <- outstandR(...)
```
